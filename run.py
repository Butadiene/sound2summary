...
prompt_for_sound2text = "この音声はプラズマ物理学という分野についての研究室でのセミナーを録音したものです。大学院の研究室で行われており、多数の参加者がいます。"
prompt_for_summarization = "この文章は、プラズマ物理学という分野についての研究室でのセミナーをWhisperを用いて文字起こしを行ったものです。ホームページの掲載用に，セミナー議事録の内容を要約してください。"
